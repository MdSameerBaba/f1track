...
const CIRCUIT_COORDINATES: Record<string, [number, number][]> = {
  albert_park: [
    // ── CLOSURE POINT at mid-pit-straight (smooth Catmull-Rom seam) ──
    [280, 298],
    // ── PIT STRAIGHT second half (heading LEFT toward T1) ───────────
    [270, 298], [260, 298], [250, 298], [240, 298], [230, 298],
    [220, 298], [210, 298], [200, 298], [190, 298], [180, 298],
    [170, 298], [160, 298], [150, 298], [140, 298], [130, 298],
    [122, 298],
    // ── T1: Jones Corner — RIGHT ~90° ──────────────────────────────
    [116, 297], [111, 296], [106, 294], [101, 291], [98, 287],
    [95, 282], [93, 277], [92, 272], [92, 267], [92, 262],
    // ── T2: LEFT kink ~40° ─────────────────────────────────────────
    [93, 257], [94, 253], [96, 249], [99, 245], [103, 242],
    [107, 240],
    // ── Short straight T2→T3 ───────────────────────────────────────
    [111, 237], [115, 234], [118, 230],
    // ── T3: RIGHT ~70° ─────────────────────────────────────────────
    [121, 226], [123, 222], [124, 218], [125, 213], [125, 209],
    [124, 205], [123, 201],
    // ── Straight T3→T4 ────────────────────────────────────────────
    [122, 196], [121, 191], [120, 186], [119, 181], [118, 176],
    [117, 171],
    // ── T4: Modified hairpin — RIGHT ~115° ─────────────────────────
    [115, 166], [113, 162], [111, 158], [108, 155], [105, 152],
    [101, 150], [97, 149], [93, 148], [89, 148],
    // ── T5: LEFT kink ~35° ─────────────────────────────────────────
    [85, 148], [81, 149], [77, 150], [74, 152],
    // ── T6: RIGHT sweeper ~130° ───────────────────────────────────
    [71, 151], [68, 148], [66, 145], [64, 141], [63, 137],
    [62, 133], [62, 129], [62, 125], [63, 121], [64, 117],
    [66, 113], [68, 109], [71, 106], [74, 102], [78, 99],
    [82, 96], [87, 93], [92, 91],
    // ── Section T6→T7 (gradual rightward sweep) ───────────────────
    [98, 88], [104, 86], [111, 84], [118, 82], [126, 80],
    [134, 78], [142, 77],
    // ── T7–T8: Connected right-handers (broad arc across top) ─────
    [151, 75], [160, 74], [170, 72], [180, 71], [190, 69],
    [200, 68], [211, 67], [222, 66], [233, 65], [244, 64],
    [255, 63], [266, 62], [277, 62], [288, 62], [299, 63],
    [310, 64], [320, 66], [330, 69], [339, 72], [348, 76],
    // ── Back straight (curving down-right toward T9) ──────────────
    [356, 80], [364, 84], [371, 89], [378, 94], [384, 99],
    [390, 105], [395, 111], [400, 117],
    // ── T9: LEFT (chicane entry — kicks rightward) ────────────────
    [404, 122], [409, 126], [414, 128], [420, 129], [426, 128],
    [431, 126],
    // ── T10: RIGHT (chicane exit — kicks back left) ───────────────
    [435, 128], [438, 131], [440, 135], [442, 140], [443, 145],
    [443, 150],
    // ── Section T10→T11 ───────────────────────────────────────────
    [443, 156], [444, 162], [445, 168],
    // ── T11: LEFT (Clark chicane entry) ───────────────────────────
    [446, 174], [448, 178], [451, 182], [455, 185], [459, 187],
    // ── T12: RIGHT (Clark chicane exit) ───────────────────────────
    [462, 189], [464, 192], [466, 196], [466, 201], [465, 206],
    [463, 211],
    // ── Section T12→T13 ──────────────────────────────────────────
    [461, 216], [458, 222], [455, 227],
    // ── T13: RIGHT ~70° ──────────────────────────────────────────
    [452, 232], [448, 237], [445, 242], [442, 247], [440, 252],
    // ── Section T13→T14 ──────────────────────────────────────────
    [438, 258], [437, 264], [436, 270],
    // ── T14: LEFT ~45° (gentle turn onto pit straight) ───────────
    [435, 276], [435, 282], [434, 288], [434, 293], [433, 298],
    // ── PIT STRAIGHT first half (T14 exit → closure point) ───────
    [430, 298], [420, 298], [410, 298], [400, 298], [390, 298],
    [380, 298], [370, 298], [360, 298], [350, 298], [340, 298],
    [330, 298], [320, 298], [310, 298], [300, 298], [290, 298],
    [280, 298],
  ],
  shanghai: [
...
const CircuitMap: FC<CircuitMapProps> = ({
  ...
  const sectorPath = (pts: [number, number][]) => catmullRomToSVG(pts, false);
